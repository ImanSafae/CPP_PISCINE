...
/*   Updated: 2022/12/12 01:14:08 by itaouil          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	some_guy->complain("error");
}

void	warning_level( Harl *some_guy )
{
	some_guy->complain("warning");
	std::cout << std::endl;
	error_level(some_guy);
}

void	info_level( Harl *some_guy )
{
	some_guy->complain("info");
	std::cout << std::endl;
	warning_level(some_guy);
}

void	debug_level( Harl *some_guy )
{
	some_guy->complain("debug");
	std::cout << std::endl;
	info_level(some_guy);
}
